...
CFG="/home/santiago/archmic/Tp4/CortexA15L1.py"
...
L1_SIZES=("2kB" "4kB" "8kB" "16kB" "32kB")

OUT_SIM_BASE="${BASE_DIR}/runs_L1_A15"
OUT_CSV_DIR="${BASE_DIR}/plots_L1_A15"

CSV_OUT="${OUT_CSV_DIR}/resultats_L1_A15_dijkstra.csv"
