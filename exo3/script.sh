...
# --------- CHEMINS A ADAPTER ----------
GEM5="$HOME/Documentos/Ensta/ArchitectureMicroprocesseurs/gem5/build/RISCV/gem5.opt"
CFG="$HOME/Documentos/Ensta/ArchitectureMicroprocesseurs/Cache-memories-Performance-evaluation-of-different-cache-memory-configurations/se_cache.py"

BIN_DIR="$HOME/Documentos/Ensta/ArchitectureMicroprocesseurs/Cache-memories-Performance-evaluation-of-different-cache-memory-configurations/exo3/"   # là où sont les .riscv
# -------------------------------------
