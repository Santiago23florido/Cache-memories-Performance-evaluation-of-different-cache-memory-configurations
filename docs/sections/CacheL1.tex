\section{Impact de la taille des caches L1}

\subsection{Configuration de L1 performances pour le Cortex A7}
\textbf{Param\`etres de simulation Gem5 utilis\'es (campagne L1, Cortex-A7) :}
\begin{itemize}
\item \textbf{Coeur :} \texttt{DerivO3CPU} (profil Cortex-A7).
\item \textbf{I-L1 (cache/bloc/assoc.) :} \texttt{\{1,2,4,8,16\}kB / 32B / 2}.
\item \textbf{D-L1 (cache/bloc/assoc.) :} \texttt{\{1,2,4,8,16\}kB / 32B / 2}.
\item \textbf{L2 (cache/bloc/assoc.) :} \texttt{512kB / 32B / 8}.
\item \textbf{Pr\'edicteur de branchement :} \texttt{BiModeBP}, \texttt{BTBEntries=256}.
\item \textbf{Fetch queue :} \texttt{8}.
\item \textbf{Decode/Issue/Commit :} \texttt{2 / 4 / 2}.
\item \textbf{RUU/LSQ :} \texttt{2 / 8} (avec \texttt{LQ=8}, \texttt{SQ=8}).
\end{itemize}

Le paramètre \texttt{fetchQueueSize} implémenté est celui fourni dans le dépôt, tel qu’il apparaît dans le fichier de base distribué. Il convient de préciser qu’il ne correspond pas à la valeur indiquée dans le tableau, mais qu’il s’agit bien de la valeur imposée par le fichier de configuration fourni.
...
\newcommand{\cacheloneplotwidth}{0.33\linewidth}

\begin{figure}[H]
\centering
\subfloat[CPI (A7).]{\includegraphics[width=\cacheloneplotwidth]{../dijkstra/plots_L1_A7/cpi_bar.png}}
\subfloat[IPC (A7).]{\includegraphics[width=\cacheloneplotwidth]{../dijkstra/plots_L1_A7/ipc_bar.png}}
\subfloat[Cycles (A7).]{\includegraphics[width=\cacheloneplotwidth]{../dijkstra/plots_L1_A7/numCycles_bar.png}}\\
\subfloat[CPI (A15).]{\includegraphics[width=\cacheloneplotwidth]{../dijkstra/plots_L1_A15/cpi_bar.png}}
\subfloat[IPC (A15).]{\includegraphics[width=\cacheloneplotwidth]{../dijkstra/plots_L1_A15/ipc_bar.png}}
\subfloat[Cycles (A15).]{\includegraphics[width=\cacheloneplotwidth]{../dijkstra/plots_L1_A15/numCycles_bar.png}}
...
\begin{figure}[H]
\centering
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../dijkstra/plots_L1_A7/icache_miss_bar.png}}
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../dijkstra/plots_L1_A7/dcache_miss_bar.png}}
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../dijkstra/plots_L1_A7/l2_miss_bar.png}}\\
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../dijkstra/plots_L1_A15/icache_miss_bar.png}}
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../dijkstra/plots_L1_A15/dcache_miss_bar.png}}
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../dijkstra/plots_L1_A15/l2_miss_bar.png}}
...
\begin{figure}[H]
\centering
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../dijkstra/plots_L1_A7/bp_cond_mispredict_rate_bar.png}}
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../dijkstra/plots_L1_A7/bp_mispredict_rate_bar.png}}
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../dijkstra/plots_L1_A7/btb_hit_ratio_bar.png}}\\
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../dijkstra/plots_L1_A15/bp_cond_mispredict_rate_bar.png}}
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../dijkstra/plots_L1_A15/bp_mispredict_rate_bar.png}}
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../dijkstra/plots_L1_A15/btb_hit_ratio_bar.png}}
...
\begin{figure}[H]
\centering
\subfloat[CPI (A7).]{\includegraphics[width=\cacheloneplotwidth]{../blowfish/plots_L1_A7/cpi_bar.png}}
\subfloat[IPC (A7).]{\includegraphics[width=\cacheloneplotwidth]{../blowfish/plots_L1_A7/ipc_bar.png}}
\subfloat[Cycles (A7).]{\includegraphics[width=\cacheloneplotwidth]{../blowfish/plots_L1_A7/numCycles_bar.png}}\\
\subfloat[CPI (A15).]{\includegraphics[width=\cacheloneplotwidth]{../blowfish/plots_L1_A15/cpi_bar.png}}
\subfloat[IPC (A15).]{\includegraphics[width=\cacheloneplotwidth]{../blowfish/plots_L1_A15/ipc_bar.png}}
\subfloat[Cycles (A15).]{\includegraphics[width=\cacheloneplotwidth]{../blowfish/plots_L1_A15/numCycles_bar.png}}
...
\begin{figure}[H]
\centering
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../blowfish/plots_L1_A7/icache_miss_bar.png}}
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../blowfish/plots_L1_A7/dcache_miss_bar.png}}
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../blowfish/plots_L1_A7/l2_miss_bar.png}}\\
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../blowfish/plots_L1_A15/icache_miss_bar.png}}
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../blowfish/plots_L1_A15/dcache_miss_bar.png}}
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../blowfish/plots_L1_A15/l2_miss_bar.png}}
...
\begin{figure}[H]
\centering
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../blowfish/plots_L1_A7/bp_cond_mispredict_rate_bar.png}}
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../blowfish/plots_L1_A7/bp_mispredict_rate_bar.png}}
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../blowfish/plots_L1_A7/btb_hit_ratio_bar.png}}\\
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../blowfish/plots_L1_A15/bp_cond_mispredict_rate_bar.png}}
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../blowfish/plots_L1_A15/bp_mispredict_rate_bar.png}}
\subfloat{\includegraphics[width=\cacheloneplotwidth]{../blowfish/plots_L1_A15/btb_hit_ratio_bar.png}}
...
\subsection{Configuration de L1 performances pour le Cortex A15}
\textbf{Param\`etres de simulation Gem5 utilis\'es (campagne L1, Cortex-A15) :}
\begin{itemize}
\item \textbf{Coeur :} \texttt{DerivO3CPU} (profil Cortex-A15).
\item \textbf{I-L1 (cache/bloc/assoc.) :} \texttt{\{2,4,8,16,32\}kB / 64B / 2}.
\item \textbf{D-L1 (cache/bloc/assoc.) :} \texttt{\{2,4,8,16,32\}kB / 64B / 2}.
\item \textbf{L2 (cache/bloc/assoc.) :} \texttt{512kB / 64B / 16}.
\item \textbf{Pr\'edicteur de branchement :} \texttt{LocalBP}, \texttt{BTBEntries=256}.
\item \textbf{Fetch queue :} \texttt{15}.
\item \textbf{Decode/Issue/Commit :} \texttt{4 / 8 / 4}.
\item \textbf{RUU/LSQ :} \texttt{16 / 16} (avec \texttt{LQ=16}, \texttt{SQ=16}).
...
Cela s’explique par la nature essentiellement calculatoire de l’algorithme et par la r\'egularit\'e de ses acc\`es, qui rendent les d\'efauts de cache moins fr\'equents d\`es qu’une petite capacit\'e est disponible ; l’augmentation de L1 a donc un impact limit\'e. Cette lecture met en \'evidence une logique d’optimisation diff\'erenci\'ee : un L1 plus grand est pertinent lorsque la charge de travail pr\'esente des acc\`es irr\'eguliers et une faible localit\'e de donn\'ees, tandis qu’une charge plus r\'eguli\`ere et calculatoire atteint rapidement la saturation, rendant l’augmentation de capacit\'e moins justifiable en termes de surface et d’\'energie. On peut \'egalement constater que, pour les deux applications, le pr\'edicteur de branchement en fonction de la taille du cache L1 ne pr\'esente pas de variations significatives associ\'ees \`a ce param\`etre.
